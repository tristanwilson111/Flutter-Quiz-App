  ...
  Widget build(BuildContext context) {
    return new Material(
      ...
      child: new InkWell(
        onTap: () => widget._onTap(),
        child: new Column(
          mainAxisAlignment: MainAxisAlignment.center, //Aligns the overlay objects to the center of the screen
          children: <Widget>[
            new Container(
              decoration: new BoxDecoration( //Adds a white circle behind the checkmark icon
                color: Colors.white,
